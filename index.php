            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    <div class="search-bar d-flex align-items-center position-relative">
                        ...
                        <div id="searchResults" class="position-absolute w-100 bg-white shadow" style="display: none; z-index: 1000;"></div>
                    </div>
                </div>
                <div class="d-flex align-items-center">
                    ...
                    <div class="profile-section dropdown">
                        <img src="<?php echo htmlspecialchars($profile['avatar_path']); ?>" class="rounded-circle me-2 profile-pic" alt="Profile" data-bs-toggle="dropdown">
                        <ul class="dropdown-menu dropdown-menu-end">
            ...
            <div class="col-md-6 p-3 feed-area">
                            ...
                            <div class="story-item" data-user-id="<?php echo htmlspecialchars($story['user_id']); ?>">
                                <div class="story-image-container position-relative">
                                    <?php if ($story['media_type'] === 'image'): ?>
                                        <img src="<?php echo htmlspecialchars($story['media_path']); ?>" class="rounded-circle" alt="Story" onclick="showFullStory('<?php echo htmlspecialchars($story['user_id']); ?>')">
                                    <?php elseif ($story['media_type'] === 'video'): ?>
                                        <video muted class="rounded-circle" onclick="showFullStory('<?php echo htmlspecialchars($story['user_id']); ?>')">
                                            <source src="<?php echo htmlspecialchars($story['media_path']); ?>" type="video/mp4">
                                        </video>
                                    <?php endif; ?>
                                </div>
                ...
                <div class="posts-section mb-4">
                    <div class="post-input d-flex align-items-center bg-light p-2 rounded">
                        ...
                        <button class="photo-btn btn p-0 me-2" data-bs-toggle="modal" data-bs-target="#postModal"><i class="fas fa-camera"></i></button>
                    </div>
                    <div class="post-options row g-2 mt-2">
                        <div class="col-6 col-md-3">
                            <button class="btn btn-outline-primary w-100" data-bs-toggle="modal" data-bs-target="#reelModal" data-post-type="reel">
                        ...
                        <div class="reel-grid d-flex gap-3 overflow-auto">
                            <div class="reel-item">
                                <div class="reel-image-container position-relative">
                                    <img src="<?php echo htmlspecialchars($profile['avatar_path']); ?>" class="rounded" alt="Add Reel">
                                    <button class="upload-reel-btn position-absolute bottom-0 end-0 bg-primary text-white rounded-circle border-0" data-bs-toggle="modal" data-bs-target="#reelModal">
                                        <i class="fas fa-plus"></i>
                                    </button>
                                </div>
                            ...
                            <?php foreach ($reels as $reel): ?>
                                <div class="reel-item" data-reel-id="<?php echo $reel['id']; ?>" onclick="showReel(<?php echo $reel['id']; ?>, '<?php echo htmlspecialchars($reel['video_path']); ?>', '<?php echo htmlspecialchars($reel['name'] ?: $reel['username']); ?>', '<?php echo htmlspecialchars($reel['avatar_path'] ?: 'uploads/avatars/default.jpg'); ?>', <?php echo $reel['like_count']; ?>, <?php echo $reel['user_liked'] ? 'true' : 'false'; ?>)">
                                    <div class="reel-image-container position-relative">
                                    ...
                                    <p class="text-center small"><?php echo htmlspecialchars($reel['name'] ?: $reel['username'] ?: 'Unknown'); ?></p>
                                </div>
                            <?php endforeach; ?>
                            <?php if (empty($reels)): ?>
                        ...
                        <div class="post-item" data-post-id="<?php echo $post['id']; ?>">
                            ...
                            <?php if ($post['media_path']): ?>
                                <?php if ($post['media_type'] === 'image'): ?>
                                    <img src="<?php echo htmlspecialchars($post['media_path']); ?>" class="post-media w-100" alt="Post Media">
                            ...
                            <div class="post-actions d-flex gap-3 mt-2">
                                <button class="btn btn-link like-btn <?php echo $post['user_liked'] ? 'liked' : ''; ?>" onclick="toggleStatusLike(<?php echo $post['id']; ?>, this)">
                                    <i class="fa-heart <?php echo $post['user_liked'] ? 'fas text-danger' : 'far'; ?>"></i> <span class="like-count"><?php echo $post['like_count']; ?></span>
                                </button>
                                ...
                                <button class="btn btn-link" onclick="sharePost(<?php echo $post['id']; ?>)"><i class="fas fa-share"></i> Share</button>
                            </div>
                            <div class="comment-section mt-3" id="comment-section-<?php echo $post['id']; ?>" style="display: none;">
                                ...
                                <form class="d-flex mt-2" onsubmit="postComment(<?php echo $post['id']; ?>, event)">
                                    <input type="text" class="form-control me-2 comment-input-field" placeholder="Write a comment..." required>
                    ...
                    <div class="modal-body">
                        ...
                        <form id="storyForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="storyMedia" name="story_media" accept="image/jpeg,image/png,video/mp4,video/webm" required>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="postForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <textarea class="form-control" name="post_text" rows="4" placeholder="What's on your mind?"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="postMedia" class="form-label">Upload Media (Optional)</label>
                                <input type="file" class="form-control" id="postMedia" name="post_media" accept="image/jpeg,image/png,video/mp4,video/webm" multiple>
                    ...
                    <div class="modal-body">
                        ...
                        <form id="reelForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="reelMedia" name="reel_media" accept="video/mp4,video/webm" required>
                                <div id="reelPreview" class="mt-2"></div>
                            </div>
                            <div class="mb-3">
                                <label for="reelCaption" class="form-label">Caption (Optional)</label>
                                <textarea class="form-control" id="reelCaption" name="reel_caption" rows="2" placeholder="Add a caption..."></textarea>
                            </div>
                            <button type="submit" class="btn btn-primary">Upload</button>
                        </form>
                    </div>
            ...
            fetch('', {
                ...
                .then(data => {
                    ...
                    <div class="d-flex align-items-center ${isSent ? 'flex-row-reverse' : ''}">
                        <img src="${isSent ? '<?php echo htmlspecialchars($profile['avatar_path']); ?>' : msg.sender_avatar || 'Uploads/avatars/default.jpg'}" class="rounded-circle me-2" style="width: 24px; height: 24px;" alt="Profile">
